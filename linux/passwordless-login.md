...
# /etc/sudoers:%NBCUNI\\adl-sr_all_unix_localadmin        ALL=(ALL) PASSWD:ALL
# /etc/sudoers.d/security-cyberark:%useradm ALL=(ALL) NOPASSWD: /usr/bin/passwd
# /etc/sudoers.d/application-7032784:%APL-adsales_AOS ALL=(ALL) PASSWD:ALL
# /etc/sudoers.d/et-operations:nixops ALL=(ALL) PASSWD:ALL
# /etc/sudoers.d/security-qualys:nixscan ALL=(ALL) NOPASSWD:ALL
# /etc/sudoers.d/$USER_ID:$USER_ID ALL=(ALL) NOPASSWD: ALL
# /etc/sudoers.d/sintec-onair:%APL-adsales_AOS ALL=(ALL) PASSWD:ALL
# /etc/sudoers.d/enterprise-automation:nixauto ALL=(ALL) NOPASSWD:ALL
# /etc/sudoers.d/enterprise-discovery:svcud ALL=(ALL) NOPASSWD:ALL
# /etc/sudoers.d/enterprise-ops:%ADL-SR-ITInfrastructureCentrifyUNIXL1_L2_LA    ALL=(ALL) PASSWD:ALL
# /etc/sudoers.d/enterprise-ops:%ADL-SR-ITInfrastructureCentrifyUNIXL3_LA       ALL=(ALL) PASSWD:ALL
